...
def diff(output_path,input_path,magic_code)
    ...
    safety_checker = StableDiffusionSafetyChecker.from_pretrained("/mnt/e/ncdata/elepot/files/models/riffusion/safety_checker")
    feature_extractor = CLIPImageProcessor.from_pretrained("/mnt/e/ncdata/elepot/files/models/riffusion/feature_extractor")
